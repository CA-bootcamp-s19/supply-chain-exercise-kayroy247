...
modifier isOwner () { 
  ...
  modifier forSale (uint _sku) { require(items[_sku].state == State.ForSale && skuCount >= _sku , "This item is not for sale"); _;}
  modifier sold (uint _sku) { require(items[_sku].state == State.Sold, "This item has not been sold"); _;}
  modifier shipped (uint _sku) { require(items[_sku].state == State.Shipped, "This item has not been shipped"); _;}
  modifier received (uint _sku) { require(items[_sku].state == State.Received, "This item has not been received"); _;}
